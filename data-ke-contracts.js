...
const KE_CONTRACTS={
  ...
  // ── Historical OOH (from the Campaign Analysis spend history; dates approximate) ──
  "1289079-BOS":{num:"1289079-BOS",vendor:"Clear Channel Outdoor",brand:"Keches Law Group",dmas:["BOS"],category:"Billboards",mediaType:"Static PE Bulletins",qty:4,total:28960,startDate:"2026-01-01",endDate:"2026-06-30",link:"",manualStatus:"expired",notes:"Static preemptible bulletins (2026 spend $28,960). From the Keches Campaign Analysis; exact flight TBD."},
  "1180011-BOS":{num:"1180011-BOS",vendor:"Clear Channel Outdoor",brand:"Keches Law Group",dmas:["BOS"],category:"Billboards",mediaType:"Digital Bulletin",qty:1,total:100000,startDate:"2023-01-01",endDate:"2024-12-31",link:"",manualStatus:"expired",notes:"#005398 '93 South' digital (2023 $20,000 + 2024 $80,000). From the Keches Campaign Analysis; exact flight TBD."},
  "1147529-BOS":{num:"1147529-BOS",vendor:"Clear Channel Outdoor",brand:"Keches Law Group",dmas:["BOS"],category:"Billboards",mediaType:"Static Bulletin / Digital Bulletin / Static PE / Static Poster",qty:1,total:578084,startDate:"2023-01-01",endDate:"2024-12-31",link:"",manualStatus:"expired",notes:"#003700 Gallivan mixed static+digital (2023 $512,525 + 2024 $65,559). From the Keches Campaign Analysis; exact flight TBD."},
  "1145382-BOS":{num:"1145382-BOS",vendor:"Clear Channel Outdoor",brand:"Keches Law Group",dmas:["BOS"],category:"Billboards",mediaType:"Digital Bulletin / Static PE Bulletin / Static Poster",qty:1,total:54547,startDate:"2023-01-01",endDate:"2023-12-31",link:"",manualStatus:"expired",notes:"Mixed static+digital (2023 spend $54,547). From the Keches Campaign Analysis; exact flight TBD."}
};
