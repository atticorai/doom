import H, { forwardRef as S, createElement as A, useState as C, useEffect as L, useContext as K, createContext as F, useMemo as W } from "react";
import { motion as _, AnimatePresence as G } from "framer-motion";
var P = { exports: {} }, z = {};
/**
 * @license React
 ...
 */
var q = H, U = Symbol.for("react.element"), J = Symbol.for("react.fragment"), Y = Object.prototype.hasOwnProperty, Z = q.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, X = { key: !0, ref: !0, __self: !0, __source: !0 };
function O(t, s, a) {
  var r, i = {}, c = null, g = null;
  a !== void 0 && (c = "" + a), s.key !== void 0 && (c = "" + s.key), s.ref !== void 0 && (g = s.ref);
  for (r in s) Y.call(s, r) && !X.hasOwnProperty(r) && (i[r] = s[r]);
  if (t && t.defaultProps) for (r in s = t.defaultProps, s) i[r] === void 0 && (i[r] = s[r]);
  return { $$typeof: U, type: t, key: c, ref: g, props: i, _owner: Z.current };
}
z.Fragment = J;
z.jsx = O;
z.jsxs = O;
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const ce = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], pe = h("chevron-down", ce);
/**
 * @license lucide-react v0.522.0 - ISC
 *
 * This source code is licensed under the ISC license.
      ...
      /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ e.jsxs(
          "button",
          {
            ...
            className: `px-4 py-2 rounded border transition-all text-sm flex items-center gap-2 ${d ? "border-rose-300 text-rose-700 hover:bg-rose-100" : "border-rose-500/40 text-rose-300 hover:bg-rose-500/10 hover:text-rose-200"}`,
            children: [
        ...
        /* @__PURE__ */ e.jsxs(
          "button",
          {
            ...
            children: [
              t ? /* @__PURE__ */ e.jsx(fe, { size: 22 }) : /* @__PURE__ */ e.jsx(we, { size: 22 }),
              /* @__PURE__ */ e.jsx(
                "div",
                {
    ...
    /* @__PURE__ */ e.jsx("div", { className: "flex gap-4 items-center", children: /* @__PURE__ */ e.jsx(
      "div",
      {
        ...
        children: ["Postman Law", "Wettermark Keith"].map((m) => {
          const y = a === m, w = d ? "text-purple-800 border-purple-600 bg-purple-50" : "text-megara-light border-magic-gold bg-magic-gold/5", j = d ? "text-purple-400 border-transparent hover:text-purple-600 hover:bg-purple-50/50" : "text-megara-light/40 border-transparent hover:text-megara-light/70 hover:bg-white/5";
          return /* @__PURE__ */ e.jsxs(
            "button",
            {
              onClick: () => r(m),
              className: `font-serif px-6 py-3 font-medium text-sm border-b-2 transition-colors ${y ? w : j}`,
              children: [
                m,
...
const Ke = [
...
], T = () => typeof window < "u" && window.MegaraLibraryData ? window.MegaraLibraryData : Ke, M = new Proxy([], {
  get(t, s) {
    const a = T(), r = a[s];
  ...
  getOwnPropertyDescriptor(t, s) {
    return Object.getOwnPropertyDescriptor(T(), s);
  }
}), V = {
...
function We({ instruction: t, onClick: s }) {
  const a = K(B), r = t.status === "sent", i = parseInt(t.iscis) || 5, c = i > 8 ? "h-48" : i > 5 ? "h-44" : "h-40", g = {
    ...
    _.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ e.jsx(
          "div",
          {
            className: `w-full h-3 ${Fe[t.market]} opacity-90 shadow-inner relative z-10`,
...
function Ge({
  ...
  const i = s.reduce(
    (n, l) => (n[l.mediaType] || (n[l.mediaType] = []), n[l.mediaType].push(l), n),
    {}
  ), c = [
    "TV",
    "Radio",
    ...
    var l;
    return ((l = i[n]) == null ? void 0 : l.length) > 0;
  }), x = Object.keys(i).filter((n) => {
    var l;
    return !c.includes(n) && ((l = i[n]) == null ? void 0 : l.length) > 0;
  }), p = [...g, ...x];
  return /* @__PURE__ */ e.jsxs(
    _.div,
    {
      ...
      children: [
        ...
        p.map((n, l) => {
          const b = i[n], v = new Set(b.map((d) => d.market)).size;
          return /* @__PURE__ */ e.jsxs(
            _.div,
            {
              initial: {
...
function Ue() {
  try {
    const t = R(), s = t.currentTime, a = t.createOscillator();
...
function Je() {
  try {
    ...
    [1047, 1319, 1568, 2093].forEach((g, x) => {
      ...
      const n = t.createGain(), l = s + x * 0.1;
      n.gain.setValueAtTime(0, l), n.gain.linearRampToValueAtTime(0.06, l + 0.01), n.gain.exponentialRampToValueAtTime(1e-3, l + 0.6), p.connect(n), n.connect(t.destination), p.start(l), p.stop(l + 0.6);
    });
    const r = t.createOscillator();
...
function Ze({
  ...
  const r = Ye(t), c = {
    ...
    const l = typeof window < "u" && window.MegaraLibraryActions || {}, b = t == null ? void 0 : t.historyIdx;
    typeof l[n] == "function" && typeof b == "number" && (l[n](b), n === "delete" && s());
  };
            ...
            /* @__PURE__ */ e.jsxs("div", { className: "flex-1 bg-white overflow-y-auto relative", children: [
              ...
              t.sheetHtml ? /* @__PURE__ */ e.jsx(
                ...
                /* @__PURE__ */ e.jsx("div", { className: "text-center mb-6", children: (() => {
                  const l = (typeof window < "u" && window.MegaraLibraryLogos || {})[t.brand];
                  return l ? /* @__PURE__ */ e.jsx("img", { src: l, alt: t.brand, style: { height: 48, margin: "0 auto", display: "block" } }) : /* @__PURE__ */ e.jsx("div", { className: "inline-block border-2 border-gray-800 px-5 py-1.5", children: /* @__PURE__ */ e.jsx("span", { className: "font-bold text-gray-900 tracking-wider text-lg uppercase", children: t.brand.toUpperCase() }) });
                })() }),
                ...
                /* @__PURE__ */ e.jsxs("table", { className: "w-full text-sm", children: [
                  ...
                  /* @__PURE__ */ e.jsx("tbody", { children: (() => {
                    ...
                    r.forEach((m) => {
                      const y = m.notes && n.indexOf(m.notes) >= 0 ? m.notes : "All Week";
                      b[y] || (b[y] = []), b[y].push(m);
                    });
                    const v = [
                      ...n.filter((m) => {
                        var y;
                        return (y = b[m]) == null ? void 0 : y.length;
                      }),
                      ...Object.keys(b).filter((m) => !n.includes(m))
                    ], d = [];
                    return v.forEach((m) => {
                      const y = l[m] || "bg-gray-100 border-gray-200";
                      d.push(
                        /* @__PURE__ */ e.jsx("tr", { className: `${y} border-b`, children: /* @__PURE__ */ e.jsx("td", { colSpan: 5, className: "py-1.5 px-3 font-bold text-gray-800 uppercase text-xs", children: m }) }, "hdr-" + m)
                      ), b[m].forEach((w, j) => {
                        d.push(
                          /* @__PURE__ */ e.jsxs(
                            "tr",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ e.jsx("td", { className: "py-2 px-3 text-gray-600 font-mono text-xs", children: w.dates }),
                                /* @__PURE__ */ e.jsx("td", { className: "py-2 px-3 text-gray-900 font-mono text-xs", children: w.code }),
                                /* @__PURE__ */ e.jsx("td", { className: "py-2 px-3 text-gray-700 font-mono text-xs", children: w.length }),
                                /* @__PURE__ */ e.jsx("td", { className: "py-2 px-3 text-gray-700 font-mono text-xs", children: w.pct }),
                                /* @__PURE__ */ e.jsx("td", { className: "py-2 px-3 text-gray-500 text-xs", children: w.notes })
                              ]
                            },
                            m + "-" + j
                          )
...
const B = F(!1);
function et() {
  const [t, s] = C(!1), [a, r] = C("Postman Law"), [i, c] = C(!1), [g, x] = C(null);
  L(() => {
  ...
  const p = W(() => {
    ...
    "Postman Law": M.filter((o) => o.brand === "Postman Law").length,
    "Wettermark Keith": M.filter((o) => o.brand === "Wettermark Keith").length
  }, l = M.filter((o) => o.brand === a), b = i ? l : l.filter((o) => !o.archived), v = l.filter((o) => o.archived).length, d = [
    "January",
    "February",
    "March",
    "April",
    ...
    "November",
    "December"
  ], m = Array.from(new Set(b.map((o) => o.month))), y = d.filter((o) => m.includes(o)).reverse(), w = b.reduce(
    (o, k) => (o[k.month] || (o[k.month] = []), o[k.month].push(k), o),
    {}
  ), j = y.filter((o) => {
    var k;
    return ((k = w[o]) == null ? void 0 : k.length) > 0;
  }), E = new Set(b.map((o) => o.market)).size, u = t;
  return /* @__PURE__ */ e.jsx(B.Provider, { value: t, children: /* @__PURE__ */ e.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ e.jsxs("div", { className: `px-8 pb-2 text-xs font-mono tracking-wide ${u ? "text-purple-700/70" : "text-megara-light/50"}`, children: [
          /* @__PURE__ */ e.jsxs("span", { className: `font-serif text-sm font-bold tracking-widest uppercase ${u ? "text-purple-900" : "text-magic-gold"}`, children: [
            a,
            " ledger:"
          ] }),
          " ",
          ...
          /* @__PURE__ */ e.jsx("div", { className: "mt-1 flex flex-wrap gap-x-4 gap-y-0.5", children: (() => {
            const o = {};
            return l.forEach((f) => {
              const N = f.month || "?", $ = f.mediaType || "?";
              o[N] || (o[N] = {}), o[N][$] = (o[N][$] || 0) + 1;
            }), ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"].filter((f) => o[f]).reverse().map((f) => /* @__PURE__ */ e.jsxs("span", { children: [
              /* @__PURE__ */ e.jsxs("b", { className: u ? "text-purple-800" : "text-megara-light/70", children: [
                f,
                ":"
              ] }),
              " ",
              Object.entries(o[f]).map(([N, $]) => `${N}(${$})`).join(" ")
            ] }, f));
          })() })
        ] }),
